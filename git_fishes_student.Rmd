...
This task involves cloning your repository on your computer. This is your new working directory from which your project will develop. This is a very good point to make sure that you understand relative path names fo coding. 
...
Add a `data/` folder to your working directory that you just cloned down. You'll need this for your next task anyway. Think about how you would write some code to load in a data file that is within this folder. There are a few useful shortcuts you can use. For example, if you use '.' it signifies 'start from the current working directory'. That is the RStudio project file location if you click on a RStudio project. 

Now that you have a data folder, **how would you write the path name to load in a data file from the data folder?** Write your answer in the code chunk below:
