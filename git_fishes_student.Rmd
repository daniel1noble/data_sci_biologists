...
>**Question 6**: If you have added the `pics/` folder to your working directory to plot pictures of each fish on your figure explain why you would want to continue tracking these files on GitHub despite them being .png files?
