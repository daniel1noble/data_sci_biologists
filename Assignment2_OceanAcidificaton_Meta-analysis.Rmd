...
<details>
  <summary><font size="5">**Assignment Task**</font></summary>
...
<details>
  <summary><font size="5">**Assessment**</font></summary>
...
+ Correct analysis of [Clark *et al.* (2020)](https://www.nature.com/articles/s41586-019-1903-y) data to generate the summary statistics (means, SD, N) for each of the fish species' average activity. This summary data is merged with additional data columns in the meta-analysis data file. 
+ Correctly merge summary statistics from [Clark *et al.* (2020)](https://www.nature.com/articles/s41586-019-1903-y) into the larger dataset meta-analysis dataset. 
...
3) **Coding, Writing Structure & Presentation (20%)**: 
  ...
  + Figure and Tables have clear and well labelled captions that are informative
