...
i) **Statistical Analysis and Interpretation (50%)**
    1) Correct analysis of [Clark *et al.* (2020)](https://www.nature.com/articles/s41586-019-1903-y) data (i.e., `OA_activitydat_20190302_BIOL3207.csv`) to generate the summary statistics (means, SD, N) for each of the fish species' average activity. 
    ...
    5) Correct meta-analytic model fitted to the data that uses sampling variance of lnRR. The model should include a random effect of study and observation.
