...
It's clear this is giving us pretty much the same results, and it's MUCH better to include `cage` as a random effect because it greatly simplifies the model and it's interpretation. 
