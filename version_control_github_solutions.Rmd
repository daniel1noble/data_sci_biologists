...
Everyone should now have the EXACT same repo structure. As such, the code should work if they remember about how to code using relative path names. I'll explain more in the workshop.
