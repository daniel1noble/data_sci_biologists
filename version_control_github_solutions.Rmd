...
Second, to create an issue you need to head to your *GitHub* account in a browser window. Login to your *GitHub* account and go to your repo. Click on the `Issues` tab. There, you can create a new issue and assign collabortors to specific tasks. Follow the video below to see how.
