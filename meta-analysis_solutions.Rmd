...
>Our 95% prediction intervals are wide. Effect sizes (Zr) we are expected to get range from `r predict(MLMA)[[5]] #"ADD YOUR CODE HERE"` to `r predict(MLMA)[[6]] #"ADD YOUR CODE HERE"`, suggesting a lot of inconsistency between studies. 
