...
```{r, egger, fig.cap= "Plot of Fisher's Zr against sampling variance for Zr. A linear model was fit to the data."}
...
Let's first focus on some visuals in this task. Let's visualize whether we see any relationship between *average effect size* and the *year of publication*? Use `ggplot` to do this. Weight the size of the points based on their sampling error. Remember to clearly label the axes and the legend.


```{r, yearbubble, fig.cap="Plot of Zr as a function of publication year. Points are scaled in relation to their precision (1/sqrt(Zr_v)). Small points indicate effects with low precision or high sampling varaince"}
