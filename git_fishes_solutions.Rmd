...
This is also a very good point to make sure that you understand relative path names fo coding. Wait, "relative what?" 
...
Note the code chunk used to make the figure. It has a `fig.cap` argument. That means Rmarkdown knows it's a figure and it will allow you to create a figure reference call. In other words, we can refer to our Figure \@ref(fig:prettyfig) by referring to the label for the chunk. This will automatically make a legend for us too. The same concept applied to Tables but the legend goes above these.
...
**Solutions: Have a look at the video solutions**
