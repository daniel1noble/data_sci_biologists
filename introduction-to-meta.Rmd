...
There you have it. When you see the sampling variance equations in Table \@ref(tab:tablea) all you need to remember is that these are shortcuts to doing the simulations we have just done above. If you don't belive me, lets do this again with a more complicated effect size statistic, log response ratio. 
