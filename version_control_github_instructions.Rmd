...
3) If the code runs then add a statistical test to explore whether the control vs high CO^2 treatments differ for each of the five fish species. Think about how you might use a loop to run these tests.
