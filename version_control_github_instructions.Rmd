...
:::: {.organgebox data-latex=""}
::: {.center data-latex=""}
<font size="18">**Task 9** should take ~30-40 minutes</font>
:::
::::
...
>**Stretch Task**: Those who want a challenge, think about how you might use a loop or even some wrangling methods you have already learnt to run these tests across all 5 species in a single block of code.
...
If you're coding and want to do something experimental it's good practice to do this on a separate branch to make sure that your existing code doesn't break other parts of your project. This is very useful for analysis or building your own software. *GitHub* also makes use of certain branch names to create webpages that can be used to render and host your code and reports.

Try creating a new branch in your repo. Call this branch `testing`. This will "duplicate" your main branch, but put you along a separate path. 
...
9) Wait a little bit for GitHub pages to create the site (~5 min).
10) Now, go visit your site and share it with your partner so they can see the analysis and code you created!
