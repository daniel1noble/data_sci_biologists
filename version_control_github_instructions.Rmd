...
:::: {.organgebox data-latex=""}
::: {.center data-latex=""}
<font size="18">**Task 3--5** should take ~25 minutes</font>
:::
::::
...
Create: 1) a new RStudio project file and 2) add a new Rmarkdown file in this directory. Remember how we have been setting up our RMarkdown file structure. Make sure that you mimic that structure so that you can render the html version of it.
...
Save this file, commit and push it up to *GitHub*. Check again how your *GitHub* repo online looks. Click on the file and see what in the file has changed.
...
In your Rmarkdown file, use the data that you stored to create a single figure, anything you want really, and save this figure to the `output/figures/` folder. Check your *GitHub Desktop*. What do you notice?
